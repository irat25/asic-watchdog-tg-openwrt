...
- показывать в LuCI мини-графики за 24 часа по хешу, температуре и битым шарам;
- показывать короткий анализ 24ч в деталях ASIC: просадка хеша, перегрев, вентилятор, bad shares;
- показывать температуры по платам/чипам, хешрейт по платам, состояние плат, количество чипов;
- показывать uptime, пулы, режим autotune/разгона;
